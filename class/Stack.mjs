export default class Stack {
  ...
  /**
   * @param {Array<*>} [items=[]] - Initial items, bottom-to-top order.
   */
  constructor(items = []) {
  ...
  /**
   * @returns {*|undefined} The removed top item, or undefined if empty.
   */
  pop() {
  ...
  /**
   * @returns {*|undefined} The top item without removing it, or undefined if empty.
   */
  peek() {
